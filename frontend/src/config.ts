const isProduction =
	...
	window.location.hostname !== 'python-chasacademy.local';
...
export const API_URL = isProduction
	...
	: viteEnv.VITE_API_URL || 'http://localhost:3000'; // Use VITE_API_URL for local (localhost or python-chasacademy.local)
